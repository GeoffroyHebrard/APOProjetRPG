...
public class Narrative implements Event{
    ...
    public void Tell(){
        ...
        narration.add("But there was still much to do to acquire the Holy Graal.... ");
            ...
            narration.add("Bobo and Bobheal are your enemies ");
                break;
            case 4:narration.add("Now you know it's not easy to aske people for information,");
            ...
            narration.add("Roukie, Roumain and Roucool are your enemies ");
                break;    
            ...
            narration.add("Leonardo , Donatello, Michelangelo and Raphael fight you !");
            ...
            narration.add("DarkHole , DarkWizard, DarkSidius and DarkMaul fight you !");
                break;
